...
public class SceneInit : MonoBehaviour {
	...
	void Start () {
        ...
        //グローバルコンフィグ読み込み
//        this.gameManager.saveManager.loadGlobal ();           //!< PS4 環境でnovelフォルダのアクセスに失敗するのでいったん削除
...
//            StatusManager.variable.replaceAll ("global", this.gameManager.globalSetting.globalVar);       // PS4環境でnovelフォルダのアクセスに失敗するのでいったん削除
